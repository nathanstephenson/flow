...
describe("modelInForce", () => {
  ...
  it("keeps the Effort levels that announcing a resolved id used to throw away", () => {
    ...
    const view = (id: string) => ({ ...initialState(), capabilities: { providers: ["anthropic"], models: listed, compaction: true, fork: true, subagents: false, enquiries: false, permissions: false }, model: { id } });
