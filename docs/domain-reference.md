...
Detailed rules and distinctions for the terms in [CONTEXT.md](../CONTEXT.md).
Read only the sections relevant to the task. Decision history is in [adr/](adr/).
Keep short definitions in CONTEXT.md; keep detailed behaviour here.
